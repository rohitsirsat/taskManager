      ...
      <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur">
            ...
            <CardContent className="space-y-4">
                ...
                >
                  {isLoading ? (
                    <span className="flex flex-row justify-center items-center space-x-2">
                      <p>Log in</p> <Loader className="animate-spin" />
                    </span>
                  ) : (
                    "Log in"
                  )}
              ...
              <div className="text-center text-sm">
                <span className="text-muted-foreground">New to platform? </span>
                <Link
                  to="/signup"
          ...
          <div className="text-center text-xs text-muted-foreground">
            By sign in an account, you agree to our{" "}
